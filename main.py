...
if __name__ == "__main__":
    ...
    parser.add_argument('--max_paper_num', type=int, help='max_paper_num', default=50)
    ...
    parser.add_argument("--description", type=str, help="Describe your interested research area.", default=None)
    ...
    if not (args.provider == "Ollama" or args.provider == "ollama"):
        assert args.base_url is not None, "base_url is required for SiliconFlow and OpenAI"
        assert args.api_key is not None, "api_key is required for SiliconFlow and OpenAI"
    ...
    elif args.provider == "OpenAI" or args.provider == "openai" or args.provider == "SiliconFlow" or args.provider == "siliconflow":
